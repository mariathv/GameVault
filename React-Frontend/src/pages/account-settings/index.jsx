...
import { toggle2FA } from "@/src/api/users"; // Import the new toggle2FA function
      ...
      try {
        ...
        const gamesOwned =
          inventoryData?.inventory?.reduce(
            (total, order) => total + (order.games?.length || 0),
            0
          ) || 0;
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
      <div className="bg-(--color-background)/60 p-4 rounded-lg">
        ...
        {stats.isLoading ? (
          ...
          <p className="text-2xl font-bold text-(--color-foreground)/80">
            {stats.gamesOwned}
          </p>
        )}
      </div>
...
export default function AccountSettingsPage() {
  ...
  // New function to handle 2FA toggle
  const handleToggle2FA = async () => {
    try {
      ...
      if (response) {
        ...
        toast.error(
          response.message || "Failed to toggle two-factor authentication"
        );
      }
    } catch (error) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-(--color-background) rounded-lg p-4 shadow-lg">
              <div className="flex items-center space-x-3 mb-6 p-2">
                ...
                <div>
                  <h3 className="text-(--color-foreground) font-medium">
                    {user.username || "User"}
                  </h3>
          ...
          <div className="lg:col-span-3">
            <div className="bg-(--color-background) rounded-lg shadow-lg overflow-hidden">
              ...
              {activeTab === "security" && (
                <div className="p-6">
                  <h2 className="text-2xl font-bold text-(--color-foreground)/90 mb-6">
                    Security Settings
                  </h2>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="bg-(--color-background)/60 p-6 rounded-lg">
                      <h3 className="text-xl font-bold text-(--color-foreground)/90 mb-4">
                        Change Password
                      </h3>
                    ...
                    {/* 2FA Section - Simplified with toggle switch */}
                      ...
                      {is2FAEnabled && (
                        <div className="mt-4 p-4 bg-[#2a3349] rounded-lg">
                          ...
                          <p className="text-gray-400 text-sm">
                            ...
                            layer of security. You will be asked for a
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <div className="flex space-x-2">
                              <Button
                                variant="ghost"
                                size="sm"
                                className="text-(--color-foreground) hover:bg-(--color-background)/60"
                              >
                                Edit
                              </Button>
                              <Button
                    ...
                    <div className="bg-(--color-background)/80 p-6 rounded-lg">
                      ...
                      <Button
                        variant="outline"
                        className="border-[#2a3349] text-(--color-foreground) hover:bg-(--color-background)/60"
                      >
